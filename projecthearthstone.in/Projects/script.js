// Hearthstone Projects - Interactive Logic
...
const projects = [
    {
        ...
        shortDesc: "Our flagship AI model with 99.7% accuracy, supporting fingerspelling and speech-to-text across Python and JavaScript frameworks, optimized for Raspberry Pi.",
        ...
        techStack: ["TensorFlow", "MediaPipe", "Python", "JavaScript", "Raspberry Pi"],
    ...
    },
    {
        ...
        shortDesc: "Early prototype using Arduino and flex sensors to translate ASL fingerspelling.",
        ...
        description: "Our first iteration — a hardware-based glove that captured finger bends to recognize fingerspelling letters. Though it laid the foundation, we moved on to a more powerful AI-driven approach."
    },
    {
        id: 3,
        title: "Hearthstone ASL Course",
        shortDesc: "Gamified learning platform that teaches ASL through interactive lessons, progression tracking, and a complete course system built with HTML, CSS, and JavaScript.",
        ...
        description: "Learning ASL should be fun. Our ASL Course platform turns education into a game — complete lessons, earn XP, unlock achievements, and track your progression as you build real signing skills. Built entirely with web technologies for maximum accessibility."
    }
];
...
function createProjectPanel(project, index) {
    ...
    // Spec sheet items
    const specsHtml = project.specs.map(spec => `<div class="spec-item">${spec}</div>`).join('');

    // Tech pills
    const techPillsHtml = project.techStack.map(tech => `<span class="tech-pill">${tech}</span>`).join('');
...
function updateStickyImage(imageElement, src) {
    ...
    imageElement.src = 'data:image/svg+xml,%3Csvg width="500" height="300" xmlns="http://www.w3.org/2000/svg"%3E%3Crect width="500" height="300" fill="%230a0a0a"/%3E%3Ctext x="50%25" y="50%25" font-family="Arial, sans-serif" font-size="24" fill="%2300D4FF" text-anchor="middle"%3EProject Preview%3C/text%3E%3C/svg%3E';
}
